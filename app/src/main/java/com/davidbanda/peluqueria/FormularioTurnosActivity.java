...
public class FormularioTurnosActivity extends AppCompatActivity {
    ...
    Button btnFechaInicio, btnHoraInicio;

    ArrayList<String> listaServicios = new ArrayList<>();

    private int dia,mes,ano,hora,minutos;

    EditText txtFechaInicio, txtHoraInicio, txtApellido, txtNombre, txtCelular, txtEstado;
